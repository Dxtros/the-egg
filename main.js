    ...
    const StoryEngine = {
      ...
      `);
        ...
        showQuestionScreen() {
            ...
            let html = '<div class="segment1-div">'
    ...
    const StoryContent = {
        ...
        questions: {
            setup: {
                ...
                class: "narrator-question center-text animate__animated animate__fadeIn"
            ...
            options: [
                {
                    ...
                    class: 'person-question-right',

                    answer: {
                        text: '"More or less"',
                        class: 'narrator-response afterlife-pos animate__animated animate__fadeIn',
                        timer: 3000
                    }
                },
                {
                    id: 'god',
                    text: 'Are you god?',
                    class: 'person-question-left',
                    answer: {
                        text: '"Yup, I\'m God"',
                        class: 'narrator-response god-pos animate__animated animate__fadeIn',
                        timer: 3000
                    }
                }
            ]
